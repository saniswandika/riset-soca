...
const createStructureSetupElements = t => {
  ...
  const R = {
    ...
    lt: d,
    it: z,
    ut: (t, n) => z ? hasAttrClass(C, O, n) : hasClass(C, t),
    dt: (t, n, o) => z ? attrClass(C, O, n, o) : (o ? addClass : removeClass)(C, t)
  };
  ...
  const appendElements = () => {
    ...
    if (N) {
      insertBefore(j, N);
      push(F, removeElements.bind(0, N));
    }
    if (M) {
      const t = attr(j, Et);
      attr(j, Et, "-1");
  ...
  return (t, n, l) => {
    ...
    if (u || w || v || k || j) {
      ...
      const h = {
        ...
        h: It(p ? d.innerHeight : f.h + It(i.h - e.h) + o.h)
      };
      Q = C(h);
...
const createDOMObserver = (t, n, o, s) => {
  let e = false;
  const {It: c, Lt: r, Ht: l, Mt: a, Pt: u, Dt: d} = s || {};
  const f = debounce((() => {
    if (e) {
      o(true);
    }
...
const createStructureSetupObservers = (t, n, o) => {
  ...
  let e;
  let c;
  const {W: r, J: l, Z: i, ct: a, it: d, ut: f, dt: _} = t;
...
const createScrollbarsSetup = (t, n, o) => {
  ...
  const {W: $, J: C, nt: O, ot: T, it: E, rt: z} = o.jt;
...
const OverlayScrollbars = (t, n, o) => {
  ...
  if (n && !a) {
    ...
    _("initialized", [ y ]);
    g.Bt(((t, n, o) => {
      const {ht: s, wt: e, _t: c, zt: r, At: l, Et: i, gt: a, $t: u} = t;
      _("updated", [ y, {
        updateHints: {
          sizeChanged: s,
          directionChanged: e,
...
OverlayScrollbars.env = () => {
  const {k: t, I: n, A: o, V: s, B: e, L: c, G: r, X: l, j: i, q: a, N: u, F: d} = getEnvironment();
  return assignDeep({}, {
    scrollbarsSize: t,
