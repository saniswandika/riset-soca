        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" required class="form-control" value="{{ $pengaduan->id_provinsi }}"
                            name="id_provinsi" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Kab/Kota</label>
                    <div class="col-sm-5">
                        <input type="text" required class="form-control" value="{{ $pengaduan->id_kabkot }}"
                            name="id_kabkot" id="id_kabkot" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" required class="form-control" value="{{ $pengaduan->id_kecamatan }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" required class="form-control" value="{{ $pengaduan->id_kelurahan }}"
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineCheckbox1" value="Diri Sendiri"
                                        name="jenis_pelapor"
                                        {{ $pengaduan->jenis_pelapor == 'Diri Sendiri' ? 'checked' : '' }} required>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineCheckbox2" value="Orang Lain"
                                        name="jenis_pelapor"
                                        {{ $pengaduan->jenis_pelapor == 'Orang Lain' ? 'checked' : '' }} required>
                        ...
                        <div class="input-group">
                          ...
                          <div class="input-group-text">
                            ...
                            <input type="text" id="name-input" class="form-control"
                                aria-label="Text input with checkbox" id="nodtks" value="{{ $pengaduan->no_dtks }}"
                                name="no_dtks" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $pengaduan->kepesertaan_program }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control form-control-lg" name="keluhan_tipe">
                            <option selected>Pilih...</option>
                            <option {{ $pengaduan->keluhan_tipe == 'Large select' ? 'selected' : '' }}>Large select
                            </option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        value="{{ $pengaduan->kategori_pengaduan }}" id="inlineCheckbox1"
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"
                                        value="{{ $pengaduan->kategori_pengaduan }}" id="inlineCheckbox2"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $pengaduan->no_kartu_progam }}"
                            name="no_kartu_progam">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Ringkasan Pengaduan <span class="text-danger">*</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $pengaduan->keluhan_detail }}"
                            name="keluhan_detail" required>
                    </div>
                </div>
                <div class="form-group row">
                                ...
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" id="inlineCheckbox1"
                                            value="{{ $r->id }}" name="diteruskan"
                                            {{ $pengaduan->diteruskan == "$r->id" ? 'checked' : '' }}>
            ...
            $('#btn-check-id').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.found == true) {
                            $('#name-input').val(data
                            .Id_DTKS); // Set nilai input kedua ke nama yang diambil dari server jika ID ditemukan
