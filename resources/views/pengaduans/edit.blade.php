    ...
    <div class="content px-3">
        ...
        <div class="card">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" value="{{ $pengaduan->jenis_pelapor }} id="inlineCheckbox1" value="Diri_Sendiri"
                        ...
                        <div class="col">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" value="{{ $pengaduan->jenis_pelapor }}" type="radio" id="inlineCheckbox2" value="Orang Lain"
                                    name="jenis_pelapor" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <div class="row">
                        <div class="col">
                            <div class="form-check form-check-inline">
                                <input type="radio" value="{{ $pengaduan->memiliki_nik }}" class="form-check-input" name="memiliki_nik" value="1">
                                <label class="form-check-label" for="inlineCheckbox1">Ya</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" value="{{ $pengaduan->memiliki_nik }}" name="memiliki_nik" value="0">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="number" class="form-control" value="{{ $pengaduan->no_kis }}" name="no_kis">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama <span class="text-danger">*</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->nama }}" name="nama" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Tempat Lahir <span class="text-danger">*</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->tempat_lahir }}" name="tempat_lahir" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Tanggal Lahir <span class="text-danger">*</label>
                <div class="col-sm-5">
                    <input type="date" class="form-control" value="{{ $pengaduan->tgl_lahir }}" name="tgl_lahir" required>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="tel" class="form-control" value="{{ $pengaduan->telp }}" name="telpon" required>
                    <small id="nikhelper" class="form-text text-muted">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->hubungan_terlapor }}" name="hubungan_terlapor">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->kepesertaan_program }}" name="kepesertaan_program">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">No Peserta <span class="text-danger">*</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->no_peserta }}" name="no_peserta" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label"></label>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select class="form-control form-control-lg"  name="level_program">
                        <option value="{{ $pengaduan->level_program }}" selected>{{ $pengaduan->level_program }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select class="form-control form-control-lg" value="{{ $pengaduan->keluhan_tipe }}" name="keluhan_tipe">
                        <option selected>{{ $pengaduan->keluhan_id_program }}</option>
                        <option>Large select</option>
                      </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <select class="form-control form-control-lg"  name="keluhan_id_program">
                        <option value="{{ $pengaduan->keluhan_id_program }}" selected>{{ $pengaduan->keluhan_id_program }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->no_kartu_progam }}" name="no_kartu_progam">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Ringkasan Pengaduan <span class="text-danger">*</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" value="{{ $pengaduan->keluhan_detail }}" name="keluhan_detail" required>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Detail Pengaduan <span class="text-danger">*</label>
                <div class="col-sm-5">
                    <textarea class="form-control" value="{{ $pengaduan->detail_pengaduan }}" name="detail_pengaduan" required></textarea>
                </div>
            </div>
            <div class="form-group row">
