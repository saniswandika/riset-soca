        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="option1" name="status"
                                        value="1" {{ $rekomendasiTerdaftarYayasan->jenis_pelapor == 'Diri_Sendiri' ? 'checked' : '' }} checked disabled>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="option1" name="status"
                                        value="0" {{ $rekomendasiTerdaftarYayasan->jenis_pelapor == 'Orang Lain' ? 'checked' : '' }} disabled>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="memiliki_nik" value="1"
                                        {{ $rekomendasiTerdaftarYayasan->ada_nik == '1' ? 'checked' : '' }} checked disabled>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="number" id="id-input-nik" value="{{ $rekomendasiTerdaftarYayasan->nik }}" class="form-control" name="nik" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <button class="btn btn-info" id="btn-check-id"><i class="fa fa-database" disabled></i> Cek DTKS</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->no_kk }}" name="no_kk" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->nama }}" name="nama" required readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->alamat }}" name="alamat" readonly>
                    </div>
                </div>
                {{-- layanan --}}
                {{-- <div form-group row>
