...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            {!! Form::model($rekomendasiTerdaftarYayasan, ['route' => ['rekomendasi_terdafar_yayasans.update', $rekomendasiTerdaftarYayasan->id], 'method' => 'patch']) !!}
            <div class="card-body">
                    ...
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="option1" name="status"
                                        value="1" {{ $rekomendasiTerdaftarYayasan->jenis_pelapor == 'Diri_Sendiri' ? 'checked' : '' }}>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" id="option1" name="status"
                                        value="0" {{ $rekomendasiTerdaftarYayasan->jenis_pelapor == 'Orang Lain' ? 'checked' : '' }}>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="memiliki_nik" value="1"
                                        {{ $rekomendasiTerdaftarYayasan->ada_nik == '1' ? 'checked' : '' }}>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="memiliki_nik" value="0"
                                        {{ $rekomendasiTerdaftarYayasan->ada_nik == '0' ? 'checked' : '' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="number" id="id-input-nik" value="{{ $rekomendasiTerdaftarYayasan->nik }}" class="form-control"
                            name="nik">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" id="name-input" class="form-control" aria-label="Text input with checkbox"
                        id="nodtks" value="{{ $rekomendasiTerdaftarYayasan->no_dtks }}" name="no_dtks" readonly hidden>
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status_dtks" id="status_dtks"
                                        value="1" disabled {{ $rekomendasiTerdaftarYayasan->no_dtks ? 'checked' : ''}}>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input type="radio" class="form-check-input" name="status_dtks" id="status_dtks"
                                        value="0" disabled {{ !$rekomendasiTerdaftarYayasan->no_dtks ? 'checked' : ''}}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->no_kk }}" name="no_kk">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->nama }}" name="nama"
                            required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->email }}" name="email">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Hubungan dengan terlapor</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->hubungan_terlapor }}"
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->id_program_sosial }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->no_peserta }}"
                            name="no_peserta">
                    </div>
                </div>
                <div class="form-group row">
                ...
                {{-- rekomendasiTerdaftarYayasan Program --}}

                <div form-group row>
                    <h4><b>rekomendasiTerdaftarYayasan PROGRAM</b></h4>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Program</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="kepesertaan_program"
                            value="{{ $rekomendasiTerdaftarYayasan->kepesertaan_program }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Kategori rekomendasiTerdaftarYayasan <span class="text-danger">*</label>
                    <div class="col-sm-5">
                        <div class="row">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineCheckbox2" value="1"
                                        name="jenis_pelapor" {{ $rekomendasiTerdaftarYayasan->kategori_rekomendasiTerdaftarYayasan == '1' ? 'checked' : '' }}
                                        required>
                            ...
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="inlineCheckbox2"
                                        value="{{ $rekomendasiTerdaftarYayasan->kategori_rekomendasiTerdaftarYayasan }}" name="jenis_pelapor"
                                        {{ $rekomendasiTerdaftarYayasan->kategori_rekomendasiTerdaftarYayasan == '2' ? 'checked' : '' }} required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control form-control-lg" value="{{ $rekomendasiTerdaftarYayasan->level_program }}"
                            name="level_program">
                            <option selected value="{{ $rekomendasiTerdaftarYayasan->level_program }}">{{ $rekomendasiTerdaftarYayasan->level_program }}.
                            </option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control form-control-lg" name="sektor_program">
                            <option selected value="{{ $rekomendasiTerdaftarYayasan->sektor_program }}">{{ $rekomendasiTerdaftarYayasan->sektor_program }}
                            </option>
                            <option></option>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->no_kartu_program }}"
                            name="no_kartu_program">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Ringkasan rekomendasiTerdaftarYayasan <span class="text-danger">*</label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" value="{{ $rekomendasiTerdaftarYayasan->ringkasan_rekomendasiTerdaftarYayasan }}"
                            name="ringkasan_rekomendasiTerdaftarYayasan" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Detail rekomendasiTerdaftarYayasan <span class="text-danger">*</label>
                    <div class="col-sm-5">
                        <textarea class="form-control" name="detail_rekomendasiTerdaftarYayasan">{{ $rekomendasiTerdaftarYayasan->detail_rekomendasiTerdaftarYayasan }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control form-control-lg" name="status_aksi" required>
                            <option selected value="{{ $rekomendasiTerdaftarYayasan->status_aksi }}">{{ $rekomendasiTerdaftarYayasan->status_aksi }}</option>
            ...
            <div class="card-footer">
                <a href="{{ route('rekomendasiTerdaftarYayasans.index') }}" class="btn btn-default"> Batal </a>
